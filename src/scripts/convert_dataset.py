#!/usr/bin/env python3
"""Convert Planetoid or OGB graphs to the project CSR format."""
...
def main():
    ...
    parser.add_argument("source", choices=("planetoid", "ogb"))
    parser.add_argument("dataset", help="Planetoid or OGB dataset name")
